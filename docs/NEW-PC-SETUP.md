...
- JetBrains AI WSL Patch `1.3.0`, tag `jbai-261.25134.237-patch-1.3.0`.
- WSL 2 distribution `Ubuntu`, пользователь `4erk`, home `/home/4erk`.
- Codex CLI `0.146.0`, Codex ACP `1.1.7`, Node `24.13.0`.
...
git checkout jbai-261.25134.237-patch-1.3.0
...
Ожидается пользователь `4erk`, Linux project path, Linux Codex из IDE-specific runtime и версия `0.146.0`.
